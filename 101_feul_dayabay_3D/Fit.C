...
int main()
{
  ...
  int ndf = min.NFree() - 2; // 2 contrained
  ...
  min.SetErrorDef( 2.2977 ); min.Contour(0,1, Npoints_usr, fit_DYB_s239_1s, fit_DYB_s235_1s);
  min.SetErrorDef( 6.2021 ); min.Contour(0,1, Npoints_usr, fit_DYB_s239_2s, fit_DYB_s235_2s);
  min.SetErrorDef(11.6182 ); min.Contour(0,1, Npoints_usr, fit_DYB_s239_3s, fit_DYB_s235_3s);
